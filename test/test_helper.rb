...
require 'offsite_payments_liqpay_v3'

OffsitePaymentsLiqpayV3.mode = :test
...
module OffsitePaymentsLiqpayV3
  module Assertions
    ...
    def assert_deprecation_warning(message)
      OffsitePaymentsLiqpayV3.expects(:deprecated).with(message)
      yield
    end

    def silence_deprecation_warnings
      OffsitePaymentsLiqpayV3.stubs(:deprecated)
      yield
    end

    def assert_no_deprecation_warning
      OffsitePaymentsLiqpayV3.expects(:deprecated).never
      yield
    end
...
Test::Unit::TestCase.class_eval do
  include OffsitePaymentsLiqpayV3
end

module ActionViewHelperTestHelper
  def self.included(base)
    base.send(:include, OffsitePaymentsLiqpayV3::ActionViewHelper)
